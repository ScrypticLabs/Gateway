/* 
* @File: FadeAnimation.java
* @Author: Abhi Gupta
* 
* Creates a fade animation that will be used to display and hide a notification when requested
*/
...
public class FadeAnimation implements TrayAnimation {
     ...
     * @param customStage The stage associated with the fade animation 
     */
