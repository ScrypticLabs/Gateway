/* 
* @File: PopupAnimation.java
* @Author: Abhi Gupta
* 
* This class implements a PopUp Animation for the notifications that appear on the top right corner of the screen.
*/
...
public class PopupAnimation implements TrayAnimation {
    ...
    // animation to dismiss a notification
    private Timeline setupDismissAnimation() {
        Timeline tl = new Timeline();
        KeyValue kv1 = new KeyValue(stage.yLocationProperty(), stage.getY() + stage.getWidth());    // location
        KeyFrame kf1 = new KeyFrame(Duration.millis(2000), kv1);
        KeyValue kv2 = new KeyValue(stage.opacityProperty(), 0.0);      // opacity
    ...
    // animation to show a notification
    private Timeline setupShowAnimation() {
        Timeline tl = new Timeline();
        KeyValue kv1 = new KeyValue(stage.yLocationProperty(), stage.getBottomRight().getY() + stage.getWidth());   // location
        ...
        KeyValue kv3 = new KeyValue(stage.opacityProperty(), 0.0);      // opacity
